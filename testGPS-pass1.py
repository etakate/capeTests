...
# Verify GPS settings have been set -- log
# Restart gps services -- needed for GPS data collection
# Collect GPS information -- log
...
if __name__ == '__main__':
    ...
    with open(capeGPSLogFile, 'a') as results:
        ...
        # Verify GPS Settings
        print '********************** BEGIN GPS SETTINGS VERIFICATION FOR ' + name_of_file + ' --- PASS 1 --- **********************'
...
#                       break
        ...
        print '\n*************************** END GPS SETTINGS VERIFICATION --- PASS 1 --- *************************** \n'
 ...
 #               os.system('python /home/sigma/controller/bin/ubx/check-gps.py')
 #               continue
 #       except Exception as e:
 #           print 'Issue occurred during GPS settings collect: ' + str(e)
                    ...
                    try: 
                        ...
                        if 'lon' not in report.keys():
                            ...
                            if report['lon'] != '0.0' and report['lat'] != '0.0':
                                ...
                                # Print report
                                stop = time.time()
                                print "********************** BEGIN GPS DATA COLLECT FOR " + name_of_file + " --- PASS 1 --- **********************"
                                print "********************** " + datetime.datetime.now().isoformat() + " ***************************\n"
...
#                                print 'Climb: ' , report['climb']
                                ...
                                try:
                                    ...
                                    if isinstance(tdelta_pass1, six.string_types):
                                        ...
                                        if -2 > tdelta_pass1 or tdelta_pass1 > 2:
